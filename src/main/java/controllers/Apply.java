...
public class Apply implements Initializable {
    ...
    void editionsauvegardersous(ActionEvent event) {
        Livre livre = new Livre("Le Seigneur des anneaux", "Tolkien", "zeg", 2000, 1, 1);
        Livre livre1 = new Livre("Le Silence des agneaux", "Hannibal", "reth", 1980, 1, 2);
        Livre livre2 = new Livre("Retour vers le futur", "Marty", "poj", 2000, 1, 3);
        Bibliotheque biblio = new Bibliotheque();
        biblio.addLivre(livre);
        biblio.addLivre(livre1);
        biblio.addLivre(livre2);
        jaxbObjectToXML(biblio);
    }
